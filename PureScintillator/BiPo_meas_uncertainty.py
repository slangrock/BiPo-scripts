...
def Thchainuncertainty(scale_other, scale_solar, scale_thchain, scale_uchain, scale_leaching, scale_signal):
    ...
    for i in range(0,182):
        ...
        #calculate mistagged events for each day
        n_coinc_mis = n_po_mis*p_bi_mis + n_po_true*p_bi_mis + n_po_mis*p_bi_true

        #calculate remaining BiPo212 coincidences for each day
        bipo_allcuts = bipo_rate*scale_signal * bipo_cut_eff * 3600 * 24 * i
...
if __name__ == '__main__':
    ...
    graph_th_0p3 = ROOT.TGraph(6)
    graph_th_10 = ROOT.TGraph(6)
    graph_th_leach_0p1 = ROOT.TGraph(6)
    graph_th_leach_5 = ROOT.TGraph(6)

    create_plot(graph_th_normal, "Thchain_other1_solar1_tchain1_uchain1_leaching1_signal1.txt")
    create_plot(graph_th_0p3, "Thchain_other1_solar1_tchain0.3_uchain1_leaching1_signal0.3.txt")
    create_plot(graph_th_10, "Thchain_other1_solar1_tchain10_uchain1_leaching1_signal10.txt")
    create_plot(graph_th_leach_0p1, "Thchain_other1_solar1_tchain1_uchain1_leaching0.1_signal1.txt")
    create_plot(graph_th_leach_5, "Thchain_other1_solar1_tchain1_uchain1_leaching5_signal1.txt")
...
# graphs - set default martker to cross, rather than .
    ...
    graph_th_0p3.GetXaxis().SetTitle("time (days)")
    graph_th_0p3.GetYaxis().SetTitle("Uncertainty (%)")
    graph_th_0p3.SetMarkerSize(2)
    graph_th_0p3.SetMarkerColor(30)
    graph_th_0p3.SetLineWidth(2)
    graph_th_0p3.SetLineColor(30)
    graph_th_0p3.Draw("ac*")
    graph_th_0p3.GetXaxis().SetRangeUser(0,180)
    graph_th_0p3.GetYaxis().SetRangeUser(0,180)
    graph_th_0p3.GetYaxis().SetRangeUser(0,20)
    graph_th_0p3.Draw("c*")
    ...
    graph_th_10.SetMarkerSize(2)
    graph_th_10.SetMarkerColor(9)
    graph_th_10.SetLineWidth(2)
    graph_th_10.SetLineColor(9)
    graph_th_10.Draw("c* same")

    c1.Update()

    graph_th_leach_0p1.SetMarkerSize(2)
    graph_th_leach_0p1.SetMarkerColor(615)
    graph_th_leach_0p1.SetLineWidth(2)
    graph_th_leach_0p1.SetLineColor(615)
    graph_th_leach_0p1.Draw("c* same")

    c1.Update()

    graph_th_leach_5.SetMarkerSize(2)
    graph_th_leach_5.SetMarkerColor(435)
    graph_th_leach_5.SetLineWidth(2)
    graph_th_leach_5.SetLineColor(435)
    graph_th_leach_5.Draw("c* same")

    c1.Update()

    l3.AddEntry(graph_th_0p3,"0.3 x Th chain rate", "lp")
    l3.AddEntry(graph_th_normal,"expected rates", "lp")
    l3.AddEntry(graph_th_10,"10 x Th chain rate", "lp")
    l3.AddEntry(graph_th_leach_0p1,"0.1 x leaching", "lp")
    l3.AddEntry(graph_th_leach_5,"5 x leaching", "lp")
    l3.SetFillColor(0)
    l3.SetTextSize(0.04)
    l3.Draw("same")

    c1.Update()
    c1.Print("/users/langrock/Dropbox/Thesis/Images/Backgrounds/Thchain_uncertainty_purescint.pdf","pdf")

    graph_u_normal = ROOT.TGraph(6)
    graph_u_0p1 = ROOT.TGraph(6)
    graph_u_10 = ROOT.TGraph(6)
    graph_u_leach_0p1 = ROOT.TGraph(6)
    graph_u_leach_10 = ROOT.TGraph(6)

    create_plot(graph_u_normal, "Uchain_other1_solar1_tchain1_uchain1_leaching1_signal1.txt")
    create_plot(graph_u_0p1, "Uchain_other1_solar1_tchain1_uchain0.1_leaching1_signal0.1.txt")
    create_plot(graph_u_10, "Uchain_other1_solar1_tchain1_uchain10_leaching1_signal10.txt")
    create_plot(graph_u_leach_0p1, "Uchain_other1_solar1_tchain1_uchain1_leaching0.1_signal1.txt")
    create_plot(graph_u_leach_10, "Uchain_other1_solar1_tchain1_uchain1_leaching10_signal1.txt")
    ...
    graph_u_0p1.GetXaxis().SetTitle("time (days)")
    graph_u_0p1.GetYaxis().SetTitle("Uncertainty (%)")
    graph_u_0p1.SetMarkerSize(2)
    graph_u_0p1.SetMarkerColor(30)
    graph_u_0p1.SetLineWidth(2)
    graph_u_0p1.SetLineColor(30)
    graph_u_0p1.Draw("ac*")
    graph_u_0p1.GetXaxis().SetRangeUser(0,180)
    graph_u_0p1.GetYaxis().SetRangeUser(0,50)
    graph_u_0p1.GetYaxis().SetRangeUser(0,2)
    graph_u_0p1.Draw("c*")
    ...
    graph_u_10.SetMarkerSize(2)
    graph_u_10.SetMarkerColor(9)
    graph_u_10.SetLineWidth(2)
    graph_u_10.SetLineColor(9)
    graph_u_10.Draw("c* same")

    c2.Update()

    graph_u_leach_0p1.SetMarkerSize(2)
    graph_u_leach_0p1.SetMarkerColor(615)
    graph_u_leach_0p1.SetLineWidth(2)
    graph_u_leach_0p1.SetLineColor(615)
    graph_u_leach_0p1.Draw("c* same")

    c2.Update()

    graph_u_leach_10.SetMarkerSize(2)
    graph_u_leach_10.SetMarkerColor(435)
    graph_u_leach_10.SetLineWidth(2)
    graph_u_leach_10.SetLineColor(435)
    graph_u_leach_10.Draw("c* same")

    c2.Update()

    l2.AddEntry(graph_u_0p1,"0.1 x U chain rate", "lp")
    l2.AddEntry(graph_u_normal,"expected rates", "lp")
    l2.AddEntry(graph_u_10,"10 x U chain rate", "lp")
    l2.AddEntry(graph_u_leach_0p1,"0.1 x leaching", "lp")
    l2.AddEntry(graph_u_leach_10,"10 x leaching", "lp")
    l2.SetFillColor(0)
    l2.SetTextSize(0.04)
    l2.Draw("same")

    c2.Update()
    c2.Print("/users/langrock/Dropbox/Thesis/Images/Backgrounds/Uchain_uncertainty_purescint.pdf","pdf")
